      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-12">
        ...
        >
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-xl mx-auto font-light leading-relaxed">
            Governance Transparency & Welfare Monitoring Platform
          </p>

          <div className="flex items-center justify-center gap-2 mt-5">
            <Sparkles className="w-4 h-4 text-teal-400" />
            <span className="text-sm text-slate-500 font-medium tracking-wide uppercase">Select your portal to continue</span>
            <Sparkles className="w-4 h-4 text-teal-400" />
          </div>
        </motion.div>
            ...
            <div className="relative rounded-2xl border border-slate-700/60 bg-slate-900/60 backdrop-blur-xl p-8 transition-all duration-500
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
                  Access public welfare services, track your applications, file complaints, and check your eligibility status.
                </p>
          ...
          >
            <div className="relative rounded-2xl border border-slate-700/60 bg-slate-900/60 backdrop-blur-xl p-8 transition-all duration-500
              ...
              <div className="relative z-10">
                ...
                {/* Description */}
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
                  Securely manage policies, monitor district-level welfare data, detect anomalies, and oversee citizen applications.
                </p>
